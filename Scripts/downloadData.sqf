...
T8L_var_fileSize = 1687;  								// Filesize ... smaller files will take shorter time to download!

T8L_var_TLine01 = "Hack annule";				// download aborted
T8L_var_TLine02 = "Hack en cours!";			// download already in progress by someone else
T8L_var_TLine03 = "Hack en cours!";				// download started
T8L_var_TLine04 = "Hack terminé!";			// download finished
T8L_var_TLine05 = "<t color='#ff1111'>Hacker le terminal</t>";				// line for the addaction
T8L_var_TLine06 = "Connection ...";
...
T8L_fnc_ActionLaptop =
{
	...
	[] execVM "standMissions\Missions\endMissions01.sqf"
	};
};
