...
//trigger Group 0 
	...
	_tgrStatement = "nul = execVM 'standCqb\CQB3\level1\group0.sqf';";
	_tgrCondition = "this";
	_tgr = createTrigger ["EmptyDetector",_triggerPos];
	_dir = _triggerPos select 2;
...
//trigger Group 1 
	...
	_tgrStatement = "nul = execVM 'standCqb\CQB3\level1\group1.sqf';";
	_tgrCondition = "this";
	_tgr = createTrigger ["EmptyDetector",_triggerPos];
	_dir = _triggerPos select 2;
...
//trigger Group 2 
	...
	_tgrStatement = "nul = execVM 'standCqb\CQB3\level1\group2.sqf';";
	_tgrCondition = "this";
	_tgr = createTrigger ["EmptyDetector",_triggerPos];
	_dir = _triggerPos select 2;
